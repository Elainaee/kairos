...
export class AiDataStore {
  constructor(legacyPath, options = {}) { this.legacyPath = legacyPath; this.queue = Promise.resolve(); this.database = options.database || null; this.databaseReady = null; this.databasePath = options.databasePath || ":memory:"; this.memoryService = options.memoryService || null; }
